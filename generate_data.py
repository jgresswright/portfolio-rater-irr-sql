...
# Save
# ---------------------------------------------------------------------------
raters.to_csv("/home/claude/sql_portfolio/data/raters.csv", index=False)
evaluations.to_csv("/home/claude/sql_portfolio/data/evaluations.csv", index=False)
ratings.to_csv("/home/claude/sql_portfolio/data/ratings.csv", index=False)
